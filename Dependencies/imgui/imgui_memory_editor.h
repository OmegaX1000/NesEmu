            ...
            for (int line_i = clipper.DisplayStart; line_i < clipper.DisplayEnd; line_i++) // display only visible lines
            {
                ...
                for (int n = 0; n < Cols && addr < mem_size; n++, addr++)
                {
                    ...
                    if (DataEditingAddr == addr)
                    {
                        ...
                        ImGuiInputTextFlags flags = ImGuiInputTextFlags_ReadOnly | ImGuiInputTextFlags_CharsHexadecimal | ImGuiInputTextFlags_AutoSelectAll | ImGuiInputTextFlags_NoHorizontalScroll;
                        ...
                        //ImGui::PushStyleColor(ImGuiCol_TextSelectedBg, style.Colors[ImGuiCol_FrameBg]);
                        ImGui::InputText("##data", DataInputBuf, IM_ARRAYSIZE(DataInputBuf), flags);
